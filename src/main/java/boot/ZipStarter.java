            ...
            for (String cpDir : classPathDirs) {
                if(resourceName.startsWith(cpDir)) {
                    ...
                    if(!resourceName.endsWith(".jar")) {
                        URL targetURL = new URL("com/sahlbach/zipstarter/zip", "/", resourceName.substring(toRemove));
    ...
    private void initJarFile (String jarName, InputStream is) throws IOException {
        ...
        while ((je = jis.getNextJarEntry()) != null) {
            if (!je.isDirectory()) {
                ...
                storeUrlResource(new URL("com/sahlbach/zipstarter/zip", jarName + "/", resourceName), b);
            }
        }
    }
